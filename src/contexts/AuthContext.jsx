...
export const AuthProvider = ({ children }) => {
  ...
  // Load users from localStorage or use empty array
  const loadUsersFromStorage = () => {
    try {
      const stored = localStorage.getItem('projectflow_users');
  ...
  const [allUsers, setAllUsers] = useState(() => loadUsersFromStorage());
